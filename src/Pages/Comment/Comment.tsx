...
const Comment: React.FC = (): JSX.Element => {
    ...
    return (
        <Container maxWidth="sm">
            <TextDrawer openDrawer={openDrawer} closeDrawer={closeDrawer} onChange={onChange} formData={value}
            ...
            {HomeStore.allPosts[id]?.comments.map((el: any, index: number) => (
                <div key={index} style={{width: '100%', display: 'flex', alignItems: 'flex-end', flexDirection: 'column'}}>
